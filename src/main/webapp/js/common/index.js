...
(function(global) {
    ...
    function makeContextModuleFunc(e, t, n) {
        return function() {
            ...
            return n && isFunction(i = r[r.length - 1]) && (i.__requireJsBuild = !0),
            r.push(t),
            e.apply(null , r)
        }
    }
    ...
    function newContext(e) {
        ...
        function m(e, t, n) {
            ...
            e && e.charAt(0) === "." && (t ? (o.pkgs[t] ? g = m = [t] : g = m.slice(0, m.length - 1),
            e = g.concat(e.split("/")),
            v(e),
            i = o.pkgs[r = e[0]],
            e = e.join("/"),
            i && e === r + "/" + i.main && (e = r)) : e.indexOf("./") === 0 && (e = e.substring(2)));
            if (n && (m || b) && y) {
                u = e.split("/");
        ...
        function b(e, t, n, i) {
            ...
            return e || (v = !1,
            e = "_@r" + (h += 1)),
            a !== -1 && (f = e.substring(0, a),
            e = e.substring(a + 1, e.length)),
            f && (f = m(f, c, i),
            o = l[f]),
            e && (f ? o && o.normalize ? g = o.normalize(e, function(e) {
                return m(e, c, i)
            }) : g = m(e, c, i) : (g = m(e, c, i),
            s = r.nameToUrl(g))),
            u = f && !o && !n ? "_unnormalized" + (p += 1) : "",
            {
                prefix: f,
                name: g,
                parentMap: t,
        ...
        function x() {
            globalDefQueue.length && (apsp.apply(f, [f.length - 1, 0].concat(globalDefQueue)),
            globalDefQueue = [])
        }
        function T(e, t, n) {
            var i = e && e.map
              , s = makeContextModuleFunc(n || r.require, i, t);
            return addRequireMethods(s, r, i),
            s.isBrowser = isBrowser,
            s
        }
        function N(e) {
            delete u[e],
        ...
        function C(e, t) {
            ...
            each(r, function(e) {
                ...
                if (!s)
                    return;
                return !s.inited || !s.enabled ? (i = null ,
                delete t[n],
                !0) : i = C(s, mixin({}, t))
            }),
            i)
        ...
        function A() {
            ...
            if (l && c.length)
                return i = makeError("timeout", "Load timeout for modules: " + c, null , c),
            ...
            eachProp(u, L)),
            (!l || a) && h && (isBrowser || isWebWorker) && !s && (s = setTimeout(function() {
                s = 0,
                A()
            }, 50)),
            t = !1
        ...
        function _(e) {
            ...
            return M(t, r.onScriptLoad, "load", "onreadystatechange"),
            M(t, r.onScriptError, "error"),
            {
                node: t,
        ...
        n.prototype = {
            init: function(e, t, n, r) {
                ...
                this.depMaps.rjsSkipMap = e.rjsSkipMap,
                this.errback = n,
                this.inited = !0,
            ...
            check: function(e) {
                ...
                if (!this.inited)
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(a)) {
                            if (this.events.error)
                                ...
                                o = r.execCb(i, a, s, o);
                            this.map.isDefine && (n = this.module,
                            n && n.exports !== undefined && n.exports !== this.exports ? o = n.exports : o === undefined && this.usingExports && (o = this.exports));
                            if (t)
                            ...
                            o = a;
                        this.exports = o,
                        this.map.isDefine && !this.ignore && (l[i] = o,
                    ...
                    this.defining = !1,
                    e || this.defined && !this.defineEmitted && (this.defineEmitted = !0,
            ...
            callPlugin: function() {
                ...
                E(n, "defined", bind(this, function(n) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        s = b(e.prefix + "!" + f, this.map.parentMap, !1, !0),
                        E(s, "defined", bind(this, function(e) {
                            this.init([], function() {
                                return e
                            }, null , {
                                enabled: !0,
                        ...
                        a = u[s.id],
                        a && (this.events.error && a.on("error", bind(this, function(e) {
                            this.emit("error", e)
                        })),
                        a.enable());
                        return
            ...
            enable: function() {
                ...
                each(this.depMaps, bind(this, function(e, t) {
                    var n, s, o;
                    if (typeof e == "string") {
                        e = b(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.depMaps.rjsSkipMap),
                        this.depMaps[t] = e,
                        o = i[e.id];
                        if (o) {
                    ...
                    n = e.id,
                    s = u[n],
                    !i[n] && s && !s.enabled && r.enable(e, this)
                })),
        ...
        r = {
            ...
            configure: function(e) {
                ...
                var t = o.pkgs
                  ...
                  , s = o.map;
                mixin(o, e, !0),
                o.paths = mixin(i, e.paths, !0),
                e.map && (o.map = mixin(s || {}, e.map, !0, !0)),
                e.shim && (eachProp(e.shim, function(e, t) {
                    isArray(e) && (e = {
                        deps: e
                    }),
                    e.exports && !e.exports.__buildReady && (e.exports = r.makeShimExports(e.exports)),
                    n[t] = e
                }),
                o.shim = n),
            ...
            requireSpecified: function(e, t) {
                ...
                hasProp(l, e) || hasProp(u, e)
            },
            require: function(t, n, i, s) {
                var o, u, a, c, h;
                if (typeof t == "string")
                    return isFunction(n) ? S(makeError("requireargs", "Invalid require call"), i) : req.get ? req.get(r, t, n) : (o = t,
                    s = n,
                    a = b(o, s, !1, !0),
                    u = a.id,
                    hasProp(l, u) ? l[u] : S(makeError("notloaded", 'Module name "' + u + '" has not been loaded yet for context: ' + e)));
                i && !isFunction(i) && (s = i,
                i = undefined),
                n && !isFunction(n) && (s = n,
                n = undefined),
                ...
                while (f.length) {
                    h = f.shift();
                    if (h[0] === null )
                        return S(makeError("mismatch", "Mismatched anonymous define() module: " + h[h.length - 1]));
                    O(h)
                }
                return c = w(b(null , s)),
                c.init(t, n, i, {
            ...
            undef: function(e) {
                ...
                delete c[t.url],
                delete a[e],
                n && (n.events.defined && (a[e] = n.events),
                N(e))
            },
            enable: function(e, t) {
                var n = u[e.id];
            ...
            toUrl: function(e, t) {
                var n = e.lastIndexOf(".")
                  , i = null ;
                return n !== -1 && (i = e.substring(n, e.length),
                e = e.substring(0, n)),
                r.nameToUrl(m(e, t && t.id, !0), i)
            },
            nameToUrl: function(e, t) {
                ...
                if (req.jsExtRegExp.test(e))
                    ...
                    for (a = u.length; a > 0; a -= 1) {
                        ...
                        if (i) {
                            e === i.name ? s = i.location + "/" + i.main : s = i.location,
                            u.splice(0, a, s);
                            break
                        }
                    }
    ...
    typeof require != "undefined" && !isFunction(require) && (cfg = require,
    require = undefined),
    req = requirejs = function(e, t, n, r) {
        var i, s, o = defContextName;
        return !isArray(e) && typeof e != "string" && (s = e,
        isArray(t) ? (e = t,
        t = n,
        n = r) : e = []),
    ...
    req.load = function(e, t, n) {
        ...
        if (isBrowser)
            ...
            i.attachEvent && !(i.attachEvent.toString && i.attachEvent.toString().indexOf("[native code") < 0) && !isOpera ? (useInteractive = !0,
    ...
    isBrowser && eachReverse(scripts(), function(e) {
        ...
        if (dataMain)
            return cfg.baseUrl || (src = dataMain.split("/"),
            mainScript = src.pop(),
    ...
    define = function(e, t, n) {
        ...
        isArray(t) || (n = t,
        t = []),
        !t.length && isFunction(n) && n.length && (n.toString().replace(commentRegExp, "").replace(cjsRequireRegExp, function(e, n) {
            t.push(n)
        }),
...
define("suds/events/Dispatcher", ["suds/oop/Class"], function(e) {
    ...
    var t = e.extend({
        ...
        removeListener: function(e, t) {
            ...
            for (; r < i; r++)
                n = this.listeners[r],
                n.name === e && n.closure === t && (this.listeners.splice(r, 1),
                r--,
                i--)
        },
        dispatch: function(e, t) {
            ...
            for (; r < i; r++) {
                n = this.listeners[r];
                if (!n)
                    continue;n.name === e && n.closure.call(null , t)
            }
        },
        hasListenerFor: function(e) {
            var t, n = 0, r = this.listeners.length;
            for (; n < r; n++)
                if (this.listeners[n].name === e)
                    return !0;
            return !1
        },
...
define("suds/helpers/MouseHelper", ["suds/events/Dispatcher", "suds/events/Interval"], function(e, t) {
    ...
    n.addListener = function(e, i) {
        e === n.MOUSE_MOVE && (n.startTracking(),
        t.addListener(t.FRAME, u)),
        r.addListener(e, i)
    }
    ,
    n.removeListener = function(e, i) {
        ...
        var s = !1;
        for (var o = 0; o < dispachter.listeners.length; o++)
            dispachter.listeners[o].name === n.MOUSE_MOVE && (s = !0);
        s === !1 && (n.stopTracking(),
        t.removeListener(t.FRAME, u))
    }
    ;
    var o = function(e) {
        n.x = e.clientX,
      ...
      , u = function(e) {
        (n.x !== i || n.y !== s) && r.dispatch(n.MOUSE_MOVE),
        i = n.x,
        s = n.y
    }
    ;
    return n.MOUSE_MOVE = "MouseHelper.MOUSE_MOVE",
    n
}),
...
define("suds/math/Bezier", ["suds/oop/Class", "suds/math/Point"], function(e, t) {
    var n = e.extend({
        ...
        initialize: function(e, t, n) {
            this.anchors = [],
            this.pixelBased = typeof t == "undefined" ? !1 : !!t,
            this.accuracy = typeof n == "undefined" ? 10 : n,
            this.time = 0,
            this.speed = e || .1,
        ...
        addAnchor: function(e) {
            ...
            if (this.pixelBased) {
                ...
                for (; r < i; r++) {
                    ...
                    u = o,
                    u = new t(this.x,this.y),
                    s += t.distance(o, u)
                }
                this.time = n,
                this.speed = Math.min(1, this.pixels / s)
            }
        },
        update: function() {
        ...
        calculate: function() {
            ...
            for (i = 1; i < t; ++i)
                for (r = 0; r < t - i; ++r)
                    n[r].x = (1 - e) * n[r].x + e * n[~~(r + 1)].x,
                    n[r].y = (1 - e) * n[r].y + e * n[~~(r + 1)].y;
            this.x = n[0].x,
            this.y = n[0].y
        },
        isComplete: function() {
...
define("suds/ui/Motion", ["suds/oop/Class", "suds/math/Point", "suds/math/Bezier"], function(e, t, n) {
    var r = e.extend({
        ...
        initialize: function(e, t, r) {
            this.radius = e || this.radius,
            this.speed = t || this.speed,
            this.accuracy = r || 10,
            this.bezier = new n(this.speed,!0,this.accuracy),
...
function() {
    ...
    define("text", [], function() {
        ...
        return typeof window != "undefined" && window.navigator && window.document ? f = function(e, t) {
         ...
         : typeof process != "undefined" && process.versions && !!process.versions.node ? (l = require.nodeRequire("fs"),
        f = function(e, t) {
            ...
            try {
                ...
                u = s.readLine(),
                u && u.length() && u.charAt(0) === 65279 && (u = u.substring(1)),
                o.append(u);
        ...
        a = {
            ...
            parseName: function(e) {
                ...
                return n = i.indexOf("!"),
                n !== -1 && (t = i.substring(n + 1, i.length),
                t = t === "strip",
                i = i.substring(0, n)),
                {
                    moduleName: r,
        ...
        each: function(t, n, r) {
            if (e && t.forEach === e)
                ...
                for (var i = 0, s = t.length; i < s; i++)
                    if (i in t && n.call(r, t[i], i) === this.BREAK)
                        return
            } else
                for (var i in t)
                    if (n.call(r, t[i], i) === this.BREAK)
                        return
        },
        defer: function(e) {
            setTimeout(e, 0)
    ...
    var r = /(\d+(\.\d+)?)px/
      , s = {
        ...
        fakeEvent: function(t, r, i, s) {
            ...
            var o = n[r];
            if (!o)
                throw new Error("Event type " + r + " not supported.");
...
define("dat/controllers/NumberController", ["dat/controllers/Controller", "dat/utils/common"], function(e, t) {
    ...
    var n = function(e, i, s) {
        ...
        this.__max = s.max,
        this.__step = s.step,
        t.isUndefined(this.__step) ? this.initialValue == 0 ? this.__impliedStep = 1 : this.__impliedStep = Math.pow(10, Math.floor(Math.log(this.initialValue) / Math.LN10)) / 10 : this.__impliedStep = this.__step,
        this.__precision = r(this.__impliedStep)
    }
    ;
    return n.superclass = e,
    t.extend(n.prototype, e.prototype, {
        setValue: function(e) {
            return this.__min !== undefined && e < this.__min ? e = this.__min : this.__max !== undefined && e > this.__max && (e = this.__max),
            this.__step !== undefined && e % this.__step != 0 && (e = Math.round(e / this.__step) * this.__step),
...
define("dat/controllers/NumberControllerSlider", ["dat/controllers/NumberController", "dat/dom/dom", "dat/utils/css", "dat/utils/common", "text!dat/controllers/NumberControllerSlider.css"], function(e, t, n, r, i) {
    ...
    var s = function(e, n, r, i, u) {
        ...
        function l(e) {
            ...
            return a.setValue(o(e.clientX, n.left, n.left + r, a.__min, a.__max)),
            !1
        }
        function c() {
        ...
        t.bind(this.__background, "mousedown", f),
...
define("dat/controllers/FunctionController", ["dat/controllers/Controller", "dat/dom/dom", "dat/utils/common"], function(e, t, n) {
    var r = function(e, n, i) {
        ...
        this.__button.innerHTML = i === undefined ? "Fire" : i,
...
define("dat/controllers/BooleanController", ["dat/controllers/Controller", "dat/dom/dom", "dat/utils/common"], function(e, t, n) {
    var r = function(e, n) {
        ...
        t.bind(this.__checkbox, "change", s, !1),
...
define("dat/controllers/factory", ["dat/controllers/OptionController", "dat/controllers/NumberControllerBox", "dat/controllers/NumberControllerSlider", "dat/controllers/StringController", "dat/controllers/FunctionController", "dat/controllers/BooleanController", "dat/utils/common"], function(e, t, n, r, i, s, o) {
    return function(u, a) {
        var f = u[a];
        if (o.isArray(arguments[2]) || o.isObject(arguments[2]))
            return new e(u,a,arguments[2]);
        if (o.isNumber(f))
            return o.isNumber(arguments[2]) && o.isNumber(arguments[3]) ? new n(u,a,arguments[2],arguments[3]) : new t(u,a,{
                min: arguments[2],
                max: arguments[3]
            });
        if (o.isString(f))
...
define("dat/color/interpret", ["dat/color/toString", "dat/utils/common"], function(e, t) {
    var n, r, i = function() {
        ...
        return t.each(s, function(i) {
            if (i.litmus(e))
                return t.each(i.conversions, function(i, s) {
                    n = i.read(e);
                    if (r === !1 && n !== !1)
                        return r = n,
                        n.conversionName = s,
    ...
    return {
        hsv_to_rgb: function(e, t, n) {
            var r = Math.floor(e / 60) % 6
              ...
              , o = n * (1 - i * t)
              , u = n * (1 - (1 - i) * t)
              , a = [[n, u, s], [o, n, s], [s, n, u], [s, o, n], [u, s, n], [n, s, o]][r];
            return {
                r: a[0] * 255,
                g: a[1] * 255,
                b: a[2] * 255
        ...
        rgb_to_hsv: function(e, t, n) {
            ...
            e == i ? o = (t - n) / s : t == i ? o = 2 + (n - e) / s : o = 4 + (e - t) / s,
            o /= 6,
            o < 0 && (o += 1),
            {
                h: o * 360,
...
define("dat/color/Color", ["dat/color/interpret", "dat/color/math", "dat/color/toString", "dat/utils/common"], function(e, t, n, r) {
    function s(e, t, n) {
        Object.defineProperty(e, t, {
            get: function() {
                return this.__state.space === "RGB" ? this.__state[t] : (u(this, t, n),
                this.__state[t])
            },
            set: function(e) {
                this.__state.space !== "RGB" && (u(this, t, n),
    ...
    function o(e, t) {
        Object.defineProperty(e, t, {
            get: function() {
                return this.__state.space === "HSV" ? this.__state[t] : (a(this),
                this.__state[t])
            },
            set: function(e) {
                this.__state.space !== "HSV" && (a(this),
    ...
    Object.defineProperty(i.prototype, "hex", {
        get: function() {
            return !this.__state.space !== "HEX" && (this.__state.hex = t.rgb_to_hex(this.r, this.g, this.b)),
            this.__state.hex
        },
        set: function(e) {
        ...
        updateDisplay: function() {
            ...
            if (e !== !1) {
                ...
                i.each(n.COMPONENTS, function(n) {
                    if (!i.isUndefined(e[n]) && !i.isUndefined(this.__color.__state[n]) && e[n] !== this.__color.__state[n])
                        return t = !0,
                        {}
                }, this),
            ...
            this.__temp.s = 1,
            this.__temp.v = 1,
            u(this.__saturation_field, "left", "#fff", this.__temp.toString()),
            i.extend(this.__input.style, {
...
define("dat/gui/GUI", ["dat/utils/css", "text!dat/gui/saveDialogue.html", "text!dat/gui/style.css", "dat/controllers/factory", "dat/controllers/Controller", "dat/controllers/BooleanController", "dat/controllers/FunctionController", "dat/controllers/NumberControllerBox", "dat/controllers/NumberControllerSlider", "dat/controllers/OptionController", "dat/controllers/ColorController", "dat/utils/requestAnimationFrame", "dat/dom/CenteredDiv", "dat/dom/dom", "dat/utils/common"], function(e, t, n, r, i, s, o, u, a, f, l, c, h, p, d) {
    function C(e, t, n, s) {
        ...
        s.before instanceof i && (s.before = s.before.__li),
        A(e, o),
        p.addClass(o.domElement, "c");
        var a = document.createElement("span");
        p.addClass(a, "property-name"),
        a.innerHTML = o.property;
        var f = document.createElement("div");
        f.appendChild(a),
        f.appendChild(o.domElement);
        var c = k(e, f, s.before);
        return p.addClass(c, N.CLASS_CONTROLLER_ROW),
        p.addClass(c, typeof o.getValue()),
        L(e, c, o),
    ...
    function k(e, t, n) {
        ...
        n ? e.__ul.insertBefore(r, params.before) : e.__ul.appendChild(r),
        e.onResize(),
        r
    }
    function L(e, t, n) {
        ...
        d.extend(n, {
            options: function(t) {
                if (arguments.length > 1)
                    return n.remove(),
                    C(e, n.object, n.property, {
                        before: n.__li.nextElementSibling,
                        factoryArgs: [d.toArray(arguments)]
                    });
                if (d.isArray(t) || d.isObject(t))
                    return n.remove(),
                    C(e, n.object, n.property, {
                        before: n.__li.nextElementSibling,
                        factoryArgs: [t]
        ...
        if (n instanceof a) {
            ...
            var i = function(t) {
                return d.isNumber(n.__min) && d.isNumber(n.__max) ? (n.remove(),
                C(e, n.object, n.property, {
                    before: n.__li.nextElementSibling,
            ...
            ;
            n.min = d.compose(i, n.min),
            n.max = d.compose(i, n.max)
        } else
            ...
            })) : n instanceof l && (p.addClass(t, "color"),
            n.updateDisplay = d.compose(function(e) {
                return t.style.borderLeftColor = n.__color.toString(),
                e
            }, n.updateDisplay),
            n.updateDisplay());
        n.setValue = d.compose(function(t) {
            return e.getRoot().__preset_select && n.isModified() && j(e.getRoot(), !0),
            t
        }, n.setValue)
    }
    function A(e, t) {
    ...
    function M(e) {
        ...
        p.bind(n, "click", function() {
            c.innerHTML = JSON.stringify(e.getSaveObject(), undefined, 2),
            w.show(),
            c.focus(),
            c.select()
        }),
    ...
    function _(e) {
        ...
        var t;
        p.bind(e.__resize_handle, "mousedown", n),
        p.bind(e.__closeButton, "mousedown", n),
    ...
    var v = "dg", m = 72, g = 20, y = "Default", b = function() {
        ...
        d.isUndefined(e.parent) && e.hideable && T.push(this),
        e.resizable = d.isUndefined(e.parent) && e.resizable,
        e.autoPlace && d.isUndefined(e.scrollable) && (e.scrollable = !0);
        ...
        Object.defineProperties(this, {
            ...
            preset: {
                ...
                set: function(n) {
                    t.parent ? t.getRoot().preset = n : e.load.preset = n,
                    B(this),
                    t.revert()
                }
            },
            ...
            closed: {
                ...
                set: function(n) {
                    e.closed = n,
                    e.closed ? p.addClass(t.__ul, N.CLASS_CLOSED) : p.removeClass(t.__ul, N.CLASS_CLOSED),
                    this.onResize(),
                    t.__closeButton && (t.__closeButton.innerHTML = n ? N.TEXT_OPEN : N.TEXT_CLOSED)
                }
            },
            load: {
                get: function() {
            ...
            useLocalStorage: {
                ...
                set: function(e) {
                    b && (n = e,
                    e ? p.bind(window, "unload", u) : p.unbind(window, "unload", u),
                    localStorage.setItem(O(t, "isLocal"), e))
                }
            }
        });
        if (d.isUndefined(e.parent)) {
            e.closed = !1,
            p.addClass(this.domElement, N.CLASS_MAIN),
        ...
        e.autoPlace && (d.isUndefined(e.parent) && (E && (S = document.createElement("div"),
        p.addClass(S, v),
        p.addClass(S, N.CLASS_AUTO_PLACE_CONTAINER),
        document.body.appendChild(S),
        E = !1),
        S.appendChild(this.domElement),
        p.addClass(this.domElement, N.CLASS_AUTO_PLACE)),
        this.parent || D(t, e.width)),
    ...
    return N.toggleHide = function() {
        x = !x,
        d.each(T, function(e) {
            e.domElement.style.zIndex = x ? -999 : 999,
            e.domElement.style.opacity = x ? 0 : 1
        })
    }
    ,
    ...
    d.extend(N.prototype, {
        ...
        onResize: function() {
            ...
            if (e.scrollable) {
                ...
                window.innerHeight - t - g < n ? (p.addClass(e.domElement, N.CLASS_TOO_TALL),
                e.__ul.style.height = window.innerHeight - t - g + "px") : (p.removeClass(e.domElement, N.CLASS_TOO_TALL),
        ...
        remember: function() {
            d.isUndefined(w) && (w = new h,
            w.domElement.innerHTML = t);
            if (this.parent)
                throw new Error("You can only call remember on a top level GUI.");
            var e = this;
            d.each(Array.prototype.slice.call(arguments), function(t) {
                e.__rememberedObjects.length == 0 && M(e),
        ...
        getSaveObject: function() {
            ...
            e.remembered[this.preset] = P(this)),
            e.folders = {},
        ...
        saveAs: function(e) {
            this.load.remembered || (this.load.remembered = {},
            this.load.remembered[y] = P(this, !0)),
            this.load.remembered[e] = P(this),
            this.preset = e,
            H(this, e, !0)
        },
        revert: function(e) {
...
define("hair/config/options", ["dat/gui/GUI", "hair/config/controllers"], function(e, t) {
    ...
    return n.close(),
    t.amount = n.add(r, "amount", 5, 40),
    t.length = n.add(r, "length", 20, 200),
    t.thickness = n.add(r, "thickness", 4, 30),
    t.type = n.add(r, "type", ["face", "circle", "flat"]),
    t.suction = n.add(r, "suction").name("Inverse"),
    t.color = n.addColor(r, "color"),
    r
}),
define("hair/Joint", ["suds/math/Point", "suds/ui/Motion", "hair/config/options"], function(e, t, n) {
    var r = e.extend({
        ...
        initialize: function(r, i) {
            ...
            this.motion = new t(5,2,10),
            r ? (s = r.x + this.distance,
            o = r.y) : (s = 0,
            o = 0),
            this._super(s, o),
            this.top = (new e).set(this),
            this.bottom = (new e).set(this)
        },
        update: function() {
            var t = this.index * n.thickness;
            if (this.successor) {
                var r = e.between(this, this.successor).normalize().multiply(t);
                this.top = r.clone().rotate(Math.PI / 2),
                this.bottom = r.clone().rotate(-Math.PI / 2);
                return
            }
            if (!this.predecessor)
                return;
            ...
            this.add(i);
            var r = e.between(this.predecessor, this).normalize()
              , s = r.clone().multiply(n.length)
              , o = this.predecessor.clone().add(s);
            this.x = o.x,
            this.y = o.y,
            this.top = this.clone().add(r.clone().multiply(t).rotate(Math.PI / 2)),
            this.bottom = this.clone().add(r.clone().multiply(t).rotate(-Math.PI / 2))
        }
    });
    return r
}),
define("hair/utils/bezier", [], function() {
    return function(e, t, n) {
        var r, i, s, o;
        for (var u = 1, a = e.length - 2; u < a; u++)
            r = e[u][n],
            i = e[u + 1][n],
            s = (r.x + i.x) * .5,
            o = (r.y + i.y) * .5,
            t.quadraticCurveTo(r.x, r.y, s, o);
        r = e[u][n],
        i = e[u + 1][n],
...
define("hair/Hair", ["suds/math/Point", "hair/Joint", "hair/utils/bezier", "hair/utils/reverse", "hair/config/options"], function(e, t, n, r, i) {
    var s = function(s) {
        ...
        this.draw = function(t) {
            ...
            for (var f = 0; f < u; f++)
                o[f].update();
            t.moveTo(a.top.x, a.top.y),
            n(o, t, "top"),
            n(r(o), t, "bottom");
            var l = e.between(a, a.top)
              , c = e.between(a, a.bottom);
            t.arc(a.x, a.y, i.thickness, Math.atan2(c.y, c.x), Math.atan2(l.y, l.x), !0),
            t.closePath(),
            t.fill(),
            t.stroke(),
            t.restore()
...
define("hair/utils/faceOrder", [], function() {
    return function(e, t) {
        ...
        r.unshift(e[t]);
        while (i > -1 || s > -1)
            i > -1 && (t + i > n - 1 ? i = -1 : (r.unshift(e[t + i]),
            i++)),
            s > -1 && (t - s < 0 ? s = -1 : (r.unshift(e[t - s]),
            s++));
        return r
    }
}),
...
define("hair/App", ["suds/events/Interval", "suds/helpers/MouseHelper", "suds/math/Point", "hair/Hair", "hair/utils/polarToCartesian", "hair/utils/circleOrder", "hair/utils/faceOrder", "hair/utils/linear", "hair/config/options", "hair/config/controllers"], function(e, t, n, r, i, s, o, u, a, f) {
    ...
    var l = function() {
        function v() {
            e.addListener(e.FRAME, y),
            t.startTracking(),
            l = document.getElementById("canvas"),
            c = l.getContext("2d"),
            p = l.width = window.innerWidth,
            d = l.height = window.innerHeight,
            m(),
            f.amount.onFinishChange(m),
            f.type.onFinishChange(g),
        ...
        function y() {
            ...
            a.type === "face" ? (b(),
            f > .5 && f < 1 ? (f = u(f, .5, 1),
            v = ~~((1 - f) * (h.length - 1))) : (f = u(f, 0, .5),
            v = ~~(f * (h.length - 1))),
            m = o(h, v)) : (v = ~~(f * (h.length - 1)),
            m = s(h, v));
            var g, y;
            for (var w = 0, E = m.length; w < E; w++)
                g = m[w],
                y = n.between(t, g.getOrigin()).normalize().multiply(20),
                a.suction && y.flip(),
                g.setForce(y),
                g.draw(c)
        }
        function b() {
            ...
            c.lineWidth = 2,
            c.arc(p / 2, d / 2, 100, 0, Math.PI, !0),
            c.closePath(),
            c.fill(),
            c.stroke(),
            c.beginPath(),
            c.fillStyle = "rgb( 0, 0, 0 )",
            c.arc(p / 2 - 30, d / 2 - 20, 7, 0, Math.PI * 2),
            c.closePath(),
            c.fill(),
            c.beginPath(),
            c.fillStyle = "rgb( 0, 0, 0 )",
